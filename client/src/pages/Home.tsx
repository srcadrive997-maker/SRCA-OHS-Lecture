...
function SummarySection() {
  const summaryItems = [
    ...
    { title: "التلوث والمواد الخطرة CBRNE", summary: "4 أنواع: بيولوجي (دم/إفرازات)، كيميائي (أحماض/سموم)، إشعاعي، غازات. لكل نوع معدات وقاية وإجراءات خاصة.", icon: "☢️", color: "#e65100" },
